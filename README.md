...
The app is built using the T3-Stack (Next.js, tRPC, Tailwind, TypeScript). The matchday data is scraped via Puppeteer (source: OneFootball) and stored in a Postgres Database, addressed via Prisma as the ORM.
